...
impl fmt::Display for RuntimeError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            RuntimeError::Nng(e) => write!(f, "nanomsg error: {}", e),
...
impl From<shared::nng::Error> for RuntimeError {
    fn from(e: shared::nng::Error) -> Self {
        RuntimeError::Nng(e)
    }
}
